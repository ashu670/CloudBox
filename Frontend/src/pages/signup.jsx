        ...
        <div className="auth-page-bg">
            ...
            <header className="auth-nav">
                ...
                <div className="auth-nav-actions">
                    <span style={{ fontSize: "13.5px", color: "rgba(220, 210, 255, 0.7)" }}>Already have an account?</span>
                    <Link to="/login" className="btn-auth-nav-link">Log In</Link>
                </div>
            </header>
            ...
            <div className="auth-wrapper">
                <div className="auth-card">
                    <div className="auth-header">
                        ...
                        <p>Join CloudBox for secure, zero-latency cloud storage</p>
                    </div>
