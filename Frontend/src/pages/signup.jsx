...
import { User, Mail, Lock, Eye, EyeOff, UserPlus, AlertCircle, Loader2, ArrowRight } from "lucide-react";
        ...
        <div className="auth-page-bg">
            ...
            <header className="auth-nav">
                ...
                <div className="auth-nav-actions">
                    <span className="auth-nav-prompt">Already have an account?</span>
                    <Link to="/login" className="btn-auth-nav-link">
                        <span>Log In</span>
                ...
                <div className="auth-card">
                    <div className="auth-header">
                        <div className="auth-header-badge">
                            <UserPlus size={22} className="auth-badge-icon" />
                        </div>
                        <h1 className="auth-title">Create Your Account</h1>
                        <p className="auth-subtitle">Join CloudBox for ultra-fast, secure cloud storage</p>
                    </div>
                    ...
                    <div className="auth-footer">
                        <span>Already have an account?</span> <Link to="/login" className="auth-footer-link">Sign in</Link>
                    </div>
                </div>
            </main>
        </div>
