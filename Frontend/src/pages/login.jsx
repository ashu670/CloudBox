        ...
        <div className="auth-page-bg">
            ...
            <header className="auth-nav">
                ...
                <div className="auth-nav-actions">
                    <span style={{ fontSize: "13.5px", color: "rgba(220, 210, 255, 0.7)" }}>Don't have an account?</span>
                    <Link to="/signup" className="btn-auth-nav-link">Sign Up</Link>
                </div>
            </header>
                ...
                <div className="auth-card">
                    <div className="auth-header">
                        <div className="auth-header-badge">
                            <LogIn size={22} color="#8b5cf6" />
                        </div>
                        <h1>Welcome Back</h1>
                        <p>Sign in to your CloudBox workspace</p>
                    </div>
                    ...
                    <div className="auth-footer">
                        New to CloudBox? <Link to="/signup">Create an account</Link>
                    </div>
                </div>
            </div>
        </div>
