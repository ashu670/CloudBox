import * as authService from '../services/authService.js';
    ...
    const COOKIE_OPTIONS = {
        httpOnly : true,   // Browser JavaScript ko cookie access karne ki permission nahi milegi. (document.cookie - likhne se cokies show hone lgti h  to iss cheez se cookies show nhi hogi)
        secure : process.env.NODE_ENV === "production",   //Agar application production me chal rahi hai  to -->   secure = true
        sameSite : 'strict',    // Ye batata hai cookie dusri website se request aane par bhejni hai ya nahi.
        maxAge : 7 * 24 * 60 * 60 * 1000   // ccokies ki ek age hogi -> HOURS, MIN, SECONDS, MILLI_SECONDS
    };
